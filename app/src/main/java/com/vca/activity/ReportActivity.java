        ...
        mFilesAdapter = new FilesAdapter(this, PicassoClient.getPicasso(), new FilesAdapter.Callback() {
            ...
            public void onFileClicked(final FileMetadata file) {
                ...
                if (mSelectedFile != null) {
                    if (FileUtils.isFileAvailableInLocal(Constants.LOCAL_Folder_REPORTS, file.getName())) {
...
//                        onRefreshFiles();
    ...
    private void downloadFile(FileMetadata file) {
        ...
        new DownloadFileTask(ReportActivity.this, DropboxClientFactory.getClient(), new DownloadFileTask.Callback() {
            @Override
        ...
        }).execute(file, Constants.LOCAL_Folder_REPORTS);
    }
